                                                    ...
                                                    <div class="col-12">
                                                        <div class="col-5 mt-3 mx-auto ">
                                                            <div class="d-grid gap-2">
                                                                <button class="btn btn-success" onclick="gotoTeacherprofile();">My Profile</button>
                                    ...
                                    <div class="col-12 user-details mt-5 d-flex justify-content-center">
                                        <div class="row">
                                            <div class="col-12 mb-3 d-flex justify-content-center">
                                                <img src="Images/black.svg" class="teaceher-icon" alt="">
                                            </div>
                                            <div class="col-12">
                                                <h1 class="fw-bold text-center mt-2 mb-2 OpenSans-ExtraBold">Welcome Teacher</h1>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        ...
                                                        <div class="box-part text-center">
                                                            ...
                                                            <a href="#" onclick="gotoaddassignments();">Click Here</a>
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        ...
                                                        <div class="box-part text-center">
                                                            ...
                                                            <i class="bi bi-file-earmark-check-fill icon-size"></i>

                                                            <div class="title mt-3">
                                                                <h4>Check Asignment</h4>
                                                            </div>
                                                            ...
                                                            <a href="#" onclick="gotoCheckAssignments();">Click Here</a>
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        ...
                                                        <div class="box-part text-center">
                                                            ...
                                                            <a href="#" onclick="gotoLectureNotes();">Click Here</a>
