                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-12 d-flex justify-content-center mt-5 mb-5">
                            <div class="col-9 mb-4 mt-5 my-profile-btt">
                                <div class="col-12 mb-5 mt-5">
                                    <h1 class="text-center fw-bold openSans-extraBold mb-5">ADD YOUR ASSIGNMENT!</h1>
                                    <hr >
                                </div>
                                                ...
                                                <form>
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col">
                                                            ...
                                                            <input type="text" id="duration" class="form-control " placeholder="Type the duration" />
                                                        </div>
                                                    </div>
                                ...
                                <div class="col-12 mt-5 mb-5">
                                    <div class="col-7 mt-3 mx-auto ">
                                        <div class="d-grid gap-2">
                                            <button class="btn btn-primary" onclick="uploadpdf1();">Upload Assignment</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
