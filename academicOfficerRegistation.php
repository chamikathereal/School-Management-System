...
?>
    ...
    <head>
        <title>Adcademic Officer | Registration</title>
                        ...
                        <div class="col-12 d-flex justify-content-center mt-5 mb-5 my-profile-details-btt">
                            <div class="col-9 mt-5 mb-5 justify-content-center">
                                ...
                                <div class="col-12 mb-5">
                                    ...
                                    <h1 class="text-center fw-bold openSans-extraBold">REAGISTER ACADEMIC OFFICER!!</h1>
                                ...
                                <div class="col-12 mt-5 mb-4 ">
                                    <div class="col-7 mt-3 mx-auto ">
                                        <div class="d-grid gap-2">
                                            <button class="btn btn-primary" onclick="academicOfficerReg();">Register</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
